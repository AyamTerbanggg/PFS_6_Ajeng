/* Kita akan menggunakan vanilla js (bukan jQuery) */
...
// Atur posisi awal item pertama yang asli
listboxWrapper.style.transform = `translateX(-${scrollPosition}px)`;
// Fungsi untuk scroll kekiri
...
scrollRightButton.addEventListener('click', () => {
    ...
    listboxWrapper.style.transition = 'transform 0.5s ease';
    listboxWrapper.style.transform = `translateX(-${scrollPosition}px)`;
    // Jika mencapai item pertama yang di-clone, reset ke item asli terakhir
